...
const HomePage = () => {
	...
	return (
		<header className='w-screen min-h-screen bg-gray-50 overflow-x-hidden opacity-1 overflow-y-hidden '>
			<section className='flex  max-w-[100vw] items-center overflow-hidden   '>
				{products.map((slide, i) => {
					...
					return (
						...
						>
							<div
								className='w-screen h-[400px]  md:min-h-[70vh]
								z-50 md:w-[60vw] relative  
							mx-auto '
							>
								<img
									src={slide.url}
			...
			<section className=' flex flex-col  md:h-1/3  md:overflow-hidden w-screen md:grid md:grid-cols-4'>
